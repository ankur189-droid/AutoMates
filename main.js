...
// LOCKED SETTINGS - Teal/Cyan Gradly Theme (adapted from holographic)
const settings = {
  ...
  specularPower: 3,
  fresnelPower: 0.8,
  backgroundColor: new THREE.Color(0x0a1a1a), // Dark teal background
  sphereColor: new THREE.Color(0x051515), // Darker teal sphere
  lightColor: new THREE.Color(0x2ec4b6), // Gradly primary teal
  ...
  cursorGlowColor: new THREE.Color(0x2ec4b6), // Teal cursor glow
